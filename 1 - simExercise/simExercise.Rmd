...
The first plot (right) shows that the distribution of the ```r format(n * ns)``` samples are **exponential**, regardless of that, the plot on the right shows that the distribution of ```r ns``` means of samples of size ```r n``` is **approximately normally distributed**. This reinforces the central limit theorem that states that the sample mean is approximately normally distributed.
